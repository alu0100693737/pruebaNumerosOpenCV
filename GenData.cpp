...
int main() {
    ...
    imgTrainingNumbers = cv::imread("/home/ivan/Documentos/pruebaNumeros/NumerosAMano.png");          // read in training numbers image
    ...
    cv::FileStorage fsClassifications("/home/ivan/Documentos/pruebaNumeros/classifications.xml", cv::FileStorage::WRITE);           // open the classifications file
    ...
    cv::FileStorage fsTrainingImages("/home/ivan/Documentos/pruebaNumeros/images.xml", cv::FileStorage::WRITE);         // open the training images file
