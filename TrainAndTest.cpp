...
int main() {
    ...
    cv::FileStorage fsClassifications("/home/ivan/Documentos/pruebaNumeros/classifications.xml", cv::FileStorage::READ);        // open the classifications file
    ...
    cv::FileStorage fsTrainingImages("/home/ivan/Documentos/pruebaNumeros/images.xml", cv::FileStorage::READ);          // open the training images file
    ...
    for (int i = 0; i < validContoursWithData.size(); i++) {            // for each contour
        if(validContoursWithData[i].fltArea > 250) {
